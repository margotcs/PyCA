...
lifetimeVec = [10	12	14	16	17 18	19 20 21 22	24	26	28];
Nit = size(lifetimeVec); Nit = Nit(2);
...
title("Total proportion of rodents versus lifetime", 'interpreter', 'tex', 'FontWeight', 'normal');
legend(legendcells);  % legendcell est un array de character ou de strings
xlabel('time')
ylabel('N_{rodents} / N_{cells}')