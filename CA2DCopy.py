...
class CA2DCopy(Automaton):
    ...
    def reset(self):
        ...
        self.world[:10, :10] = 1 #ca c'est moi qui l'ai rajoute pour voir qqchose
    ...
    def step(self):
        ...
        w, e = self.world.roll(-1, 0), self.world.roll(1, 0) #ca ca fait haut puis bas 
        n, s = self.world.roll(-1, 1), self.world.roll(1, 1) #ca ca fait gauche puis droite 
